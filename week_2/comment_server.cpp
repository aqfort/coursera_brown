...
public:
    ...
    {
        headers_.emplace_back(HttpHeader{move(name), move(value)});
        return *this;
    }
...
private:
    ...
    HttpResponse ServeUserComment(const HttpRequest &req)
    {
    ...
    HttpResponse ServeCaptcha(const HttpRequest &req)
    {
